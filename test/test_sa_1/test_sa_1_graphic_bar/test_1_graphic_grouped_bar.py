...
if __name__ == "__main__":
    ...
    path = "../../test_sa_1/test_sa_1_1_results/"
    ...
    path = "../../test_sa_1/test_sa_1_2_results/"
    df1 = pd.read_csv(path + 'test_1.csv')
    df2 = pd.read_csv(path + 'test_2.csv')
    df3 = pd.read_csv(path + 'test_3.csv')
    df4 = pd.read_csv(path + 'test_4.csv')
    ...
    path = "../../test_sa_1/test_sa_1_3_results/"
    df1 = pd.read_csv(path + 'test_1.csv')
    df2 = pd.read_csv(path + 'test_2.csv')
    df3 = pd.read_csv(path + 'test_3.csv')
    df4 = pd.read_csv(path + 'test_4.csv')
    ...
    ax.set_xlabel("\u03B8 (threshold)", fontsize = 18)
    #ax.legend()
    colors = ['black']
    ...
    filepath = Path('test/test_sa_1/test_sa_1_graphic_bar/test_sa_step_difference.pdf')
