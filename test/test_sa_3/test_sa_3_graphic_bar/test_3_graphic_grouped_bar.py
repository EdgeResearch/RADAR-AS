...
if __name__ == "__main__":
    colorarray=['black','red','green','orange','black','red','green','orange', 'black','red','green','orange']
    ...
    rects2 = ax.bar(r2, scores_sa_5, width, label='sa nrsb = 0.5', color='red', hatch='x', zorder=0)
    rects3 = ax.bar(r3, scores_sa_10, width, label='sa nrsb = 0.10', color='green', hatch='xx')
    rects4 = ax.bar(r4, scores_sa_20, width, label = "sa nrsb = 0.20", color="orange", hatch='/'),
    threshold = 0.50
    ...
    filepath = Path('test/test_sa_3/test_sa_3_graphic_bar/test_sa_nrsb_difference.pdf')
