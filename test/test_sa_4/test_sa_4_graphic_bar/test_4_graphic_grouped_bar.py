...
if __name__ == "__main__":
    ...
    rects2 = ax.bar(r2, scores_sa_10, width, label='sa NR = 0.10', color='red', hatch='x', zorder=0)
    rects3 = ax.bar(r3, scores_sa_20, width, label='sa NR = 0.20', color='orange', hatch='xx')
    rects4 = ax.bar(r4, scores_sa_30, width, label = "sa NR = 0.30", color="green", hatch='/'),
    threshold = 0.50
    ...
    filepath = Path('test/test_sa_4/test_sa_4_graphic_bar/test_sa_nr_difference.pdf')
