...
#print("FakeNewsSimulation imported from:", inspect.getfile(FakeNewsSimulation))
#print("FakeNewsSimulation init signature:", inspect.signature(FakeNewsSimulation.__init__))

modelfile = os.path.abspath('test_super_agent/netlogo/FakeNewsSimulation.nlogo')
...
def start_test_sa_1(netlogo, netlogoCommands, testParameters, log_manager=None):
    ...
    env = FakeNewsSimulation(netlogoCommands, total_ticks=testParameters.total_ticks ,log_manager=log_manager)
            ...
            for k in range(number_of_iterations):
                ...
                for l in range(ticks):
                    if l == 0:
                        ...
                        obs = dql.predict_sa_action(env, obs, log_manager=log_manager)
                    else:
                        obs = env.step(0)
